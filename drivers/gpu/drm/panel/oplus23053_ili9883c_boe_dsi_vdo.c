...
#include "../mediatek/mtk_corner_pattern/oplus23053_data_hw_roundedpattern.h"
#endif
...
#define  HLT_ILI9883C   "lcm_id=161"
struct lcm {
	struct device *dev;
...
static void lcm_panel_init(struct lcm *ctx)
{
	...
	lcm_dcs_write_seq_static(ctx, 0x88, 0xCA);    //hei
	lcm_dcs_write_seq_static(ctx, 0x89, 0xCC);   //hui
	lcm_dcs_write_seq_static(ctx, 0x8A, 0xCD);   //shuiguo
	lcm_dcs_write_seq_static(ctx, 0x8B, 0xCE);
	...
	lcm_dcs_write_seq_static(ctx, 0xAC, 0xCF);
...
void lcm_dimming_on_23053(void *dsi, dcs_write_gce cb, void *handle)
{
...
void lcm_dimming_off_23053(void *dsi, dcs_write_gce cb, void *handle)
{
	char bl_tb0[] = {0xFF, 0x98, 0x83, 0x00};
		...
		void *handle, unsigned int level)
{
	...
	char bl_tb5[] = {0xE0, 0x55, 0x95, 0x97, 0x9D, 0xA5, 0x55, 0xB3, 0xC2, 0xCF, 0xE2, 0xA9, 0xF5, 0x18, 0x39, 0x5A, 0xAA, 0x7D, 0xA5, 0xD6, 0xF5, 0xFF, 0x1A, 0x39, 0x61, 0x8F, 0x3F, 0xB3, 0xC6, 0xDA};
	char bl_tb6[] = {0xE1, 0x55, 0x95, 0x97, 0x9D, 0xA5, 0x55, 0xB3, 0xC2, 0xCF, 0xE2, 0xA9, 0xF5, 0x18, 0x39, 0x5A, 0xAA, 0x7D, 0xA5, 0xD6, 0xF5, 0xFF, 0x1A, 0x39, 0x61, 0x8F, 0x3F, 0xB3, 0xC6, 0xDA};
	char bl_tb8[] = {0xE0, 0x00, 0x00, 0x16, 0x4B, 0x80, 0x50, 0xC2, 0xFA, 0x25, 0x58, 0x95, 0x81, 0xC3, 0xF6, 0x25, 0xAA, 0x50, 0x7C, 0xB8, 0xDA, 0xFF, 0x01, 0x23, 0x4A, 0x7C, 0x3F, 0xA6, 0xC6, 0xDA};
	char bl_tb9[] = {0xE1, 0x00, 0x00, 0x16, 0x4B, 0x80, 0x50, 0xC2, 0xFA, 0x25, 0x58, 0x95, 0x81, 0xC3, 0xF6, 0x25, 0xAA, 0x50, 0x7C, 0xB8, 0xDA, 0xFF, 0x01, 0x23, 0x4A, 0x7C, 0x3F, 0xA6, 0xC6, 0xDA};
...
static int lcm_probe(struct mipi_dsi_device *dsi)
{
	...
	if (strstr(saved_command_line, HLT_ILI9883C))
...
static const struct of_device_id jdi_of_match[] = {
	{
		.compatible = "oplus23053,boe,ili9883c,dphy,vdo",
	},
	{} };
...
static struct mipi_dsi_driver jdi_driver = {
	...
	.remove = lcm_remove,
	.driver = {
			.name = "oplus23053_ili9883c_boe_vdo_lcm_drv",
			.owner = THIS_MODULE,
