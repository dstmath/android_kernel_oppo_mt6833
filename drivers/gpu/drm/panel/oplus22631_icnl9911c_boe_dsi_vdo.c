...
static void is_lp6280s()
{
	char value;

	_20015_lcm_i2c_read_bytes(0x04, &value);
	pr_info("%s: read_bytes = %d", __func__, value);
...
static void lcm_panel_init(struct lcm *ctx)
{
	...
	lcm_dcs_write_seq_static(ctx, 0xB0, 0x89, 0x88, 0x87, 0x86, 0x02, 0x03, 0x04, 0x05, 0x33, 0x33, 0x33, 0x33, 0x16, 0x02, 0x02, 0x61, 0x02, 0x02, 0x00, 0x05, 0x04, 0x03, 0x02, 0x01, 0x02, 0x03, 0x04, 0x00, 0x00, 0x00, 0x00, 0x00);
	lcm_dcs_write_seq_static(ctx, 0xB1, 0x53, 0x42, 0x85, 0x81, 0x2C, 0x02, 0x02, 0x77, 0x02, 0x02, 0x04, 0x08, 0x54, 0x00, 0x00, 0x00, 0x44, 0x40, 0x02, 0x01, 0x40, 0x02, 0x01, 0x40, 0x02, 0x01, 0x40, 0x02, 0x01, 0x00, 0x00, 0x00);
	lcm_dcs_write_seq_static(ctx, 0xB2, 0x54, 0xC4, 0x82, 0x05, 0x40, 0x02, 0x01, 0x40, 0x02, 0x01, 0x05, 0x05, 0x54, 0x0C, 0x0C, 0x0D, 0x0B);
	lcm_dcs_write_seq_static(ctx, 0xB3, 0x02, 0x10, 0x08, 0x10, 0x08, 0x26, 0x26, 0x91, 0xA2, 0x33, 0x44, 0x00, 0x26, 0x00, 0x18, 0x01, 0x02, 0x08, 0x20, 0x30, 0x0E, 0x07, 0x00, 0x00, 0x78, 0x00, 0x78, 0x08, 0x09, 0x22, 0x33, 0x00);
	lcm_dcs_write_seq_static(ctx, 0xB4, 0x43, 0x1D, 0xE3, 0x00, 0x04, 0x06, 0x1C, 0x22, 0x10, 0x12, 0x0C, 0x0E, 0x43, 0x43, 0x43, 0x43, 0x43, 0x43, 0x43, 0x43, 0x43, 0x43, 0xFF, 0xFF, 0xFC, 0x00, 0x00, 0x00);
	lcm_dcs_write_seq_static(ctx, 0xB5, 0x43, 0x1D, 0xE3, 0x00, 0x05, 0x07, 0x1C, 0x22, 0x11, 0x13, 0x0D, 0x0F, 0x43, 0x43, 0x43, 0x43, 0x43, 0x43, 0x43, 0x43, 0x43, 0x43, 0xFF, 0xFF, 0xFC, 0x00, 0x00, 0x00);
	lcm_dcs_write_seq_static(ctx, 0xB8, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xAA, 0xAA, 0xAA, 0xAA, 0xAA, 0xA0, 0xAA, 0xAA, 0xAA, 0xAA, 0xAA, 0xA0);
	lcm_dcs_write_seq_static(ctx, 0xBB, 0x01, 0x02, 0x03, 0x05, 0x04, 0x07, 0x08, 0x46, 0x0A, 0x4B, 0x00, 0x09, 0x0A);
	lcm_dcs_write_seq_static(ctx, 0xBC, 0x00, 0x00, 0x00, 0x00, 0x02, 0x20, 0xFF, 0x00, 0x03, 0x32, 0x01, 0x73, 0x33, 0x00);
	lcm_dcs_write_seq_static(ctx, 0xBD, 0xE9, 0x02, 0x4F, 0xCF, 0x72, 0xA4, 0x08, 0x44, 0xAE, 0x15);
	lcm_dcs_write_seq_static(ctx, 0xBE, 0x73, 0x87, 0x32, 0x5A, 0x0C, 0x77, 0x43, 0x07, 0x0E, 0x0E);
	...
	lcm_dcs_write_seq_static(ctx, 0xC1, 0xC0, 0x20, 0x20, 0x96, 0x04, 0x4E, 0x50, 0x04, 0x2A, 0x40, 0x36, 0x00, 0x07, 0xC0, 0x10, 0xFF, 0xC0, 0x00, 0xC0);
	...
	lcm_dcs_write_seq_static(ctx, 0xC5, 0x03, 0x1C, 0xC0, 0xA0, 0x80, 0x10, 0x42, 0x44, 0x08, 0x0D, 0x14);
	lcm_dcs_write_seq_static(ctx, 0xC6, 0x87, 0xA2, 0x24, 0x22, 0x22, 0x31, 0x7F, 0x04, 0x08, 0x00);
	lcm_dcs_write_seq_static(ctx, 0xC7, 0xFA, 0xD8, 0xBE, 0xA9, 0x82, 0x63, 0x33, 0x85, 0x4B, 0x1B, 0xEB, 0xB4, 0x07, 0xD7, 0xB7, 0x8A, 0x70, 0x49, 0x1A, 0x7F, 0xE4, 0x00);
	lcm_dcs_write_seq_static(ctx, 0xC8, 0xFA, 0xD8, 0xBE, 0xA9, 0x82, 0x63, 0x33, 0x85, 0x4B, 0x1B, 0xEB, 0xB4, 0x07, 0xD7, 0xB7, 0x8A, 0x70, 0x49, 0x1A, 0x7F, 0xE4, 0x00);
	...
	lcm_dcs_write_seq_static(ctx, 0xE0, 0x30, 0x00, 0x80, 0x88, 0x11, 0x3F, 0x22, 0x62, 0xDF, 0xA0, 0x04, 0xCC, 0x01, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF);
	lcm_dcs_write_seq_static(ctx, 0xE1, 0xDE, 0xEE, 0xEF, 0xEE, 0xEE, 0xEE, 0xF0, 0x60, 0xD0, 0xD0, 0xD0, 0xD0, 0x35, 0xD0, 0xD0, 0xD0, 0xD0, 0xD0, 0xD0, 0xB2, 0x00, 0x04, 0x2A);
	lcm_dcs_write_seq_static(ctx, 0x55, 0x01);
	lcm_dcs_write_seq_static(ctx, 0x53, 0x24);
	lcm_dcs_write_seq_static(ctx, 0x35, 0x00);
	lcm_dcs_write_seq_static(ctx, 0x11, 0x00);
	usleep_range(80000, 80010);
...
static int lcm_unprepare(struct drm_panel *panel)
{
	...
	lcm_dcs_write_seq_static(ctx, 0xF0, 0x5A, 0x59);
	lcm_dcs_write_seq_static(ctx, 0xF1, 0xA5, 0xA6);
	lcm_dcs_write_seq_static(ctx, 0xBB, 0x01, 0x02, 0x03, 0x05, 0x04, 0x07, 0x08, 0x06, 0x0A, 0x4B, 0x00, 0x09, 0x0A);
...
static int lcm_panel_poweroff(struct drm_panel *panel)
{
	...
	pr_info("%s:  \n", __func__);
	if (is_lp6280s_flag == 1) {
		_20015_lcm_i2c_write_bytes(0x1, 0x0C);
		usleep_range(2000, 2010);
		_20015_lcm_i2c_write_bytes(0x0, 0x0C);
...
/*	ctx->bias_pos = devm_gpiod_get_index(ctx->dev,
	...
	devm_gpiod_put(ctx->dev, ctx->reset_gpio);
	usleep_range(15 * 1000, 15 * 1000 + 10);
...
static struct drm_display_mode default_mode = {
	.clock = 94515,
	.hdisplay = HAC,
	.hsync_start = HAC + 80,//HFP
	.hsync_end = HAC + 80 + 4,//HSA
	.htotal = HAC + 80 + 4 + 78,//HBP
	.vdisplay = VAC,
	.vsync_start = VAC + 150,//VFP
	.vsync_end = VAC + 150 + 4,//VSA
	.vtotal = VAC + 150	+ 4 + 32,//VBP
	.vrefresh = 60,
};
		...
		void *handle, unsigned int level)
{
	...
	char bl_tb5[] = {0xC7, 0xFA, 0xD8, 0xBE, 0xA9, 0x82, 0x63, 0x33, 0x85, 0x4B, 0x1B, 0xEB, 0xB4, 0x07, 0xD7, 0xB7, 0x8A, 0x70, 0x49, 0x1A, 0x7F, 0xE4, 0x00};
	char bl_tb6[] = {0xC8, 0xFA, 0xD8, 0xBE, 0xA9, 0x82, 0x63, 0x33, 0x85, 0x4B, 0x1B, 0xEB, 0xB4, 0x07, 0xD7, 0xB7, 0x8A, 0x70, 0x49, 0x1A, 0x7F, 0xE4, 0x00};
	char bl_tb8[] = {0xC7, 0x7C, 0x6C, 0x5F, 0x52, 0x3A, 0x26, 0x03, 0x5F, 0x2D, 0x02, 0xD6, 0xA1, 0xF8, 0xC9, 0xAB, 0x80, 0x67, 0x43, 0x1A, 0x7F, 0xE0, 0x00};
	char bl_tb9[] = {0xC8, 0x7C, 0x6C, 0x5F, 0x52, 0x3A, 0x26, 0x03, 0x5F, 0x2D, 0x02, 0xD6, 0xA1, 0xF8, 0xC9, 0xAB, 0x80, 0x67, 0x43, 0x1A, 0x7F, 0xE0, 0x00};
	pr_err("%s backlight = %d\n", __func__, level);
	if (level > 4095)
                level = 4095;
...
static void cabc_switch(void *dsi, dcs_write_gce cb,
		void *handle, unsigned int cabc_mode)
{
	char bl_tb4[] = {0xE0, 0x30, 0x00, 0x80, 0x88, 0x11, 0x3F, 0x22, 0x62, 0xDF, 0xA0, 0x04, 0xCC, 0x01, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF};
	char bl_tb5[] = {0xE1, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xF0, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0x00, 0x04, 0x2A};
	char bl_tb6[] = {0xE0, 0x30, 0x00, 0x80, 0x88, 0x11, 0x3F, 0x22, 0x62, 0xDF, 0xA0, 0x04, 0xCC, 0x01, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF};
	char bl_tb7[] = {0xE1, 0xDE, 0xFE, 0xEF, 0xEE, 0xEE, 0xEE, 0xF0, 0x60, 0xD0, 0x84, 0xD0, 0xD0, 0x35, 0xD0, 0xD0, 0xD0, 0xD0, 0xD0, 0xD0, 0xB2, 0x00, 0x04, 0x2A};
	char bl_tb8[] = {0xE0, 0x30, 0x00, 0x80, 0x88, 0x11, 0x3F, 0x22, 0x62, 0xDF, 0xA0, 0x04, 0xCC, 0x01, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xF4, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF};
	char bl_tb9[] = {0xE1, 0x9D, 0xED, 0xDC, 0xDD, 0xDD, 0xDD, 0xE0, 0xC6, 0x20, 0x65, 0x20, 0x20, 0xA6, 0x20, 0x20, 0x20, 0x20, 0x20, 0x20, 0xA0, 0x00, 0x04, 0x2A};
	char bl_tb10[] = {0xE0, 0x30, 0x00, 0x80, 0x88, 0x11, 0x3F, 0x22, 0x62, 0xDF, 0xA0, 0x04, 0xCC, 0x01, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xEC, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF};
	char bl_tb11[] = {0xE1, 0x7C, 0xEC, 0xCB, 0xCC, 0xCC, 0xCC, 0xD0, 0x08, 0x22, 0x12, 0x22, 0x22, 0xB0, 0x22, 0x22, 0x22, 0x22, 0x22, 0x22, 0xE0, 0x00, 0x04, 0x2A};
	pr_err("%s cabc = %d\n", __func__, cabc_mode);
...
static int lcm_probe(struct mipi_dsi_device *dsi)
{
	...
	register_device_proc("lcd","icnl9911c_boe","BOE");
	pr_info("%s-\n", __func__);
...
static const struct of_device_id jdi_of_match[] = {
	{
		.compatible = "oplus22631,boe,icnl9911c,dphy,vdo",
	},
	{} };
...
static struct mipi_dsi_driver jdi_driver = {
	...
	.remove = lcm_remove,
	.driver = {
			.name = "oplus22631_icnl9911c_boe_hdp_dsi_vdo_lcm",
			.owner = THIS_MODULE,
