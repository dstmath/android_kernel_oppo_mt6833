...
static void lcm_dimming_on_22291(void *dsi, dcs_write_gce cb, void *handle)
{
...
static void lcm_dimming_off_22291(void *dsi, dcs_write_gce cb, void *handle)
{
	char bl_tb0[] = {0xFF, 0x98, 0x83, 0x00};
...
static struct mipi_dsi_driver jdi_driver = {
	...
	.remove = lcm_remove,
	.driver = {
			.name = "oplus22291_ili9883c_boe_vdo_lcm_drv",
			.owner = THIS_MODULE,
