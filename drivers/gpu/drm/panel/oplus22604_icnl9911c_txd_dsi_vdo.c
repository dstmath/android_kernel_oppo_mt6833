...
static void lcm_panel_init(struct lcm *ctx)
{
	...
	lcm_dcs_write_seq_static(ctx, 0xB0, 0x87, 0x86, 0x05, 0x04, 0x8A, 0x8B, 0x04, 0x05, 0x55, 0x55, 0x55, 0x55, 0x0A, 0x00, 0x00, 0x64, 0x00, 0x00, 0x0F, 0x05, 0x04, 0x03, 0x02, 0x01, 0x02, 0x03, 0x04, 0x00, 0x00, 0x00);
	lcm_dcs_write_seq_static(ctx, 0xB1, 0x53, 0x42, 0x85, 0x00, 0x0A, 0x00, 0x00, 0x64, 0x00, 0x00, 0x04, 0x08, 0x54, 0x00, 0x00, 0x00, 0x44, 0x40, 0x02, 0x01, 0x40, 0x02, 0x01, 0x40, 0x02, 0x01, 0x40, 0x02, 0x01);
	lcm_dcs_write_seq_static(ctx, 0xB2, 0x54, 0x84, 0x85, 0x05, 0x40, 0x02, 0x01, 0x40, 0x02, 0x01, 0x05, 0x05, 0x54, 0x0C, 0x0C, 0x0D, 0x0B);
	lcm_dcs_write_seq_static(ctx, 0xB3, 0x02, 0x0E, 0x0B, 0x0E, 0x0B, 0x26, 0x26, 0x91, 0xA2, 0x33, 0x44, 0x00, 0x26, 0x00, 0x18, 0x01, 0x02, 0x08, 0x20, 0x30, 0x08, 0x09, 0x44, 0x20, 0x40, 0x20, 0x40, 0x08, 0x09, 0x22, 0x33);
	lcm_dcs_write_seq_static(ctx, 0xB4, 0x02, 0x02, 0x00, 0x00, 0xE3, 0x09, 0xC1, 0x00, 0xC1, 0x0D, 0x0F, 0x11, 0x13, 0x05, 0x02, 0x02, 0x02, 0x02, 0x02, 0x02, 0x02, 0x02, 0xFF, 0xFF, 0xFC, 0x00, 0x00, 0x00);
	lcm_dcs_write_seq_static(ctx, 0xB5, 0x00, 0x00, 0x00, 0x00, 0xE3, 0x08, 0xC1, 0x00, 0xC1, 0x0C, 0x0E, 0x10, 0x12, 0x04, 0x02, 0x02, 0x02, 0x02, 0x02, 0x02, 0x02, 0x02, 0xFF, 0xFF, 0xFC, 0x00, 0x00, 0x00);
	...
	lcm_dcs_write_seq_static(ctx, 0xBC, 0x00, 0x00, 0x00, 0x00, 0x02, 0x20, 0xFF, 0x00, 0x03, 0x33, 0x01, 0x73, 0x33, 0x02);
	lcm_dcs_write_seq_static(ctx, 0xBD, 0xE9, 0x02, 0x4F, 0xCF, 0x72, 0xA4, 0x08, 0x44, 0xAE, 0x15);
	lcm_dcs_write_seq_static(ctx, 0xBE, 0x82, 0x82, 0x3D, 0x51, 0x0C, 0x77, 0x43, 0x07, 0x0E, 0x0E);
	...
	lcm_dcs_write_seq_static(ctx, 0xC1, 0xC0, 0x20, 0x20, 0x96, 0x04, 0x4E, 0x50, 0x04, 0x2A, 0x40, 0x36, 0x00, 0x07, 0xCF, 0xFF, 0xFF, 0xC0, 0x00, 0xC0);
	...
	lcm_dcs_write_seq_static(ctx, 0xC5, 0x03, 0x1C, 0xC0, 0xC0, 0x40, 0x10, 0x42, 0x44, 0x0F, 0x0F, 0x14);
	lcm_dcs_write_seq_static(ctx, 0xC6, 0x87, 0x96, 0x2A, 0x29, 0x29, 0x33, 0x7F, 0x34, 0x08, 0x04);
	lcm_dcs_write_seq_static(ctx, 0xC7, 0xFC, 0xC5, 0xA2, 0x88, 0x58, 0x38, 0x06, 0x57, 0x1F, 0xF1, 0xC4, 0x91, 0xEA, 0xBD, 0xA2, 0x77, 0x60, 0x3C, 0x1A, 0x7F, 0xC0, 0x00);
	lcm_dcs_write_seq_static(ctx, 0xC8, 0xFC, 0xC5, 0xA2, 0x88, 0x58, 0x38, 0x06, 0x57, 0x1F, 0xF1, 0xC4, 0x91, 0xEA, 0xBD, 0xA2, 0x77, 0x60, 0x3C, 0x1A, 0x7F, 0xC0, 0x00);
	...
	lcm_dcs_write_seq_static(ctx, 0xE1, 0xEF, 0xFE, 0xFE, 0xFE, 0xFE, 0xEE, 0xF0, 0x20, 0x33, 0xFF, 0x00, 0x00, 0x6A, 0x90, 0xC0, 0x0D, 0x6A, 0xF0, 0x3E, 0xFF, 0x00, 0x06, 0x40);
...
/*	ctx->bias_pos = devm_gpiod_get_index(ctx->dev,
	...
	devm_gpiod_put(ctx->dev, ctx->reset_gpio);
	usleep_range(12 * 1000, 12 * 1000 + 10);
...
static void cabc_switch(void *dsi, dcs_write_gce cb,
		void *handle, unsigned int cabc_mode)
{
	char bl_tb0[] = {0x55, 0x01};
	char bl_tb1[] = {0x55, 0x03};
	char bl_tb2[] = {0x55, 0x00};
	char bl_tb3[] = {0x55, 0x02};
	char bl_tb4[] = {0xF0, 0x5A, 0x59};
	char bl_tb5[] = {0xF1, 0xA5, 0xA6};
	char bl_tb6[] = {0xE1, 0xEF, 0xFE, 0xFE, 0xFE, 0xFE, 0xEE, 0xF0, 0x20, 0x33, 0xFF, 0x00, 0x00, 0x6A, 0x90, 0xC0, 0x0D, 0x6A, 0xF0, 0x3E, 0xFF, 0x00, 0x06, 0x40};
	char bl_tb7[] = {0xE0, 0x30, 0x00, 0x80, 0x88, 0x11, 0x3F, 0x22, 0x62, 0xDF, 0xA0, 0x04, 0xCC, 0x01, 0xFF, 0xF6, 0xFF, 0xF0, 0xFD, 0xFF, 0xFD, 0xF8, 0xF5, 0xFC, 0xFC, 0xFD, 0xFF};
	char bl_tb8[] = {0xE1, 0xBC, 0xF8, 0xCC, 0xFA, 0xDB, 0x9B, 0xF0, 0xE7, 0xF0, 0x85, 0xF0, 0x70, 0x00, 0x50, 0x00, 0x9A, 0xFD, 0xF0, 0xE0, 0xFF, 0x00, 0x06, 0x40};
	char bl_tb9[] = {0xE0, 0x30, 0x00, 0x80, 0x88, 0x11, 0x3F, 0x22, 0x62, 0xDF, 0xA0, 0x04, 0xCC, 0x01, 0xFF, 0xFA, 0xFF, 0xF0, 0xFD, 0xFF, 0xFB, 0xF8, 0xF5, 0xFC, 0xFC, 0xFB, 0xFF};
	char bl_tb10[] = {0xE1, 0x9F, 0xBE, 0xFB, 0xBE, 0xFE, 0xEE, 0xE0, 0xC1, 0x33, 0x63, 0x00, 0x00, 0xAD, 0x32, 0xC0, 0x0D, 0x6A, 0xF0, 0x3E, 0x13, 0x00, 0x06, 0x40};
	char bl_tb11[] = {0xE0, 0x30, 0x00, 0x80, 0x88, 0x11, 0x3F, 0x22, 0x62, 0xDF, 0xA0, 0x04, 0xCC, 0x01, 0xFF, 0xF6, 0xFF, 0xF0, 0xFD, 0xFF, 0xFD, 0xF8, 0xF5, 0xFC, 0xFC, 0xFD, 0xFF};
...
static int lcm_probe(struct mipi_dsi_device *dsi)
{
	...
	register_device_proc("lcd","icnl9911c_txd","TXD");
	pr_info("%s-\n", __func__);
...
static struct mipi_dsi_driver jdi_driver = {
	...
	.remove = lcm_remove,
	.driver = {
			.name = "oplus22604_icnl9911c_txd_hdp_dsi_vdo_lcm",
			.owner = THIS_MODULE,
